    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-12">
                <div class="lft_hd">
                    <a href="#home"><img src="{siteinfo('siteinfo_logo')}" alt="Logo"/></a>
                </div>
            </div>
...
<section id="blg_sec">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4">
                <div class="sidebar">
                    ...
                    <div class="widget">
                        ...
                        <div class="title_br"></div>
                        <ul class="flickr">
                            <li><img src="{$THEME}img/flck/flckr.jpg" alt=""/></li>
                            <li><img src="{$THEME}img/flck/flckr.jpg" alt=""/></li>
                            <li><img src="{$THEME}img/flck/flckr.jpg" alt=""/></li>
                            <li><img src="{$THEME}img/flck/flckr.jpg" alt=""/></li>
                            <li><img src="{$THEME}img/flck/flckr.jpg" alt=""/></li>
    ...
    <div class="col-lg-8 col-md-8 col-sm-8 pagination-wrapper">
        <ul class="pagination">
